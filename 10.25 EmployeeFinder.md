...
In this activity, you'll build a compatibility-based "EmployeeFinder" application -- basically a dating app. This full-stack site will take in results from your users' surveys, then compare their answers with those from other users. The app will then display the name and picture of the user with the best overall match. 
...
* Create a folder called `EmployeeFinder`. Inside the folder, organize your directories so it matches the following:
...
7. Once you've found the current user's most compatible employee, display the result as a modal pop-up.
